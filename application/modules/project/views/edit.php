...
<div class="body-content">
    <div class="card mb-4">
        <div class="card-body">
            ...
            <h2 class="card-title text-center mb-5 mt-3 font-weight-bold">Edit Projek</h2>
            <form>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group form-inline">
                            <label>Kode Projek&nbsp;</label>
                            <input id="kode" name="kode" type="text" class="form-control" value="<?= $table->kode ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-inline">
                            <label>Nama Projek&nbsp;</label>
                            <input style="width: 80%" name="nama" type="text" class="form-control" id="nama" value="<?= $table->nama_project ?>" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group form-inline">
                            <label>Warna&nbsp;</label>
                            <input onchange="changecolor()" class="form-control" type="color" value="<?= $table->area_color ?>" id="colormap" style="width: 30px;padding: 1px;height: 30px;">
                        </div>
                    </div>
                </div>
                <div class="row">
...
<script type="text/javascript">
    ...
    function preview(locc = []) {
        if (locc.length == 0) {
            ...
            var polygon = makePolygon(locc, document.getElementById('colormap').value)
            polygon.setMap(map)
