                                    ...
                                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item">
                                                <img class="myImage d-block w-100" src="<?= $datanya->image_2 ?>" alt="First slide">
                                            </div>
                                            <div class="carousel-item">
                                                <img class="myImage d-block w-100" src="<?= $datanya->image_3 ?>" alt="First slide">
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="d-flex flex-column p-3 mb-3 shadow-sm rounded" style="height:150px;background: <?= $color ?>">
                                ...
                                <div class="d-flex align-items-center" style="padding-top:20px;">
                                    ...
                                    <span class="text-size-3" style="color: white; letter-spacing: 0.05em;"><?= $datanya->status ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
