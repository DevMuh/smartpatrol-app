...
<div class="content-header row align-items-center m-0">
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active"><?=$this->lang->line('kategori_izin')?></li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold" style="color:#b11616"><?=$this->lang->line('kategori_izin')?></h1>
                <!-- <small>List Data for all Kategori Izin</small> -->
            </div>
        </div>
    </div>
</div>
...
<div class="body-content">
    <div class="card mb-4">
        ...
        <div id="alertSuccess"></div>
            <table id="tb_kategori_izin" class="table display table-bordered table-striped table-hover sourced dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
